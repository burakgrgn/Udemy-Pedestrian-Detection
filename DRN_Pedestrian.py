...
def read_images(path, num_img):
    array = np.zeros([num_img,64*32]) ##num_img satır, 64*32 sütun
    i = 0
    for img in os.listdir(path):
        img_path = path + "//" + img
        img = Image.open(img_path, mode="r")
        data = np.asarray(img, dtype = "uint8")
        data = data.flatten() ##for example turning 5x5 matrix into 1x25
        array[i,:] = data
        i += 1
    return array
...
# read train negative
train_negative_path = r"/Users/burakgirgin/Desktop/pedestrian/LSIFIR/Classification/Train/neg"     
...
# read train positive
train_positive_path = r"/Users/burakgirgin/Desktop/pedestrian/LSIFIR/Classification/Train/pos"     
...
test_negative_path = r"/Users/burakgirgin/Desktop/pedestrian/LSIFIR/Classification/Test/neg"     
...
test_positive_path = r"/Users/burakgirgin/Desktop/pedestrian/LSIFIR/Classification/Test/pos"     
...
plt.imshow(x_train[100,:].reshape(64,32), cmap = "gray")
